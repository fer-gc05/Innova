    ...
    <section className="relative min-h-[70vh] flex items-center justify-center">
      ...
      <div className="relative z-10 text-center text-white px-6 max-w-4xl mx-auto">
        ...
        <p className="text-lg mb-8 max-w-2xl mx-auto leading-relaxed opacity-80">
          Únete a la red de innovación de la Cámara de Comercio de Montería y lleva tu empresa al siguiente nivel.
        </p>

        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Link
            href="/empresas"
            className="bg-blue-500 hover:bg-blue-600 text-white px-8 py-3 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 flex items-center space-x-2"
          >
            <span>Saber más</span>
