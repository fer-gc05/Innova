...
export default function AdminChallengesCreate({ categories, companies, forms, publicationStatuses = ['draft','published'], activityStatuses = ['active','completed','inactive'], difficulties }: Props) {
  ...
  return (
    <MainLayout title="Crear Nuevo Reto - Admin" description="Crea un nuevo reto">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Completa la información para crear un nuevo reto
                </p>
              </div>
