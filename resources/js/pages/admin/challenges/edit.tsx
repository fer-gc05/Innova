...
import { Category, Challenge, Company, Form, FormQuestion } from '@/types';
...
export default function AdminChallengesEdit({ challenge, categories, companies, forms, formAnswers, publicationStatuses = ['draft','published'], activityStatuses = ['active','completed','inactive'], difficulties }: Props) {
  ...
  const { data, setData, put, processing, errors } = useForm({
    ...
    category_questions: formAnswers || {},
  });
    ...
    <MainLayout title={`Editar Reto - ${challenge.name}`} description="Edita la información del reto">
      <div className="bg-gray-50 py-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center space-x-3 mt-2">
                  ...
                  <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                    {challenge.publication_status === 'published' ? 'Publicado' : 'Borrador'}
                  </span>
                </div>
              </div>
          ...
          {challenge.activity_status === 'active' && (
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-amber-700">
                    <p>
                      Este reto está activo y puede tener participantes inscritos. Los cambios que realices pueden afectar a los participantes actuales.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    ...
                    <p className="text-xs text-blue-600 mb-2">
                      Define si el reto estará publicado o en borrador
                    </p>
                    <select
                      value={data.publication_status}
                      onChange={(e) => setData('publication_status', e.target.value)}
                      className="w-full px-4 py-3 text-sm border border-blue-300 rounded-lg bg-white shadow-sm transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 hover:border-blue-400"
                      required
                    >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mb-2">
                      Define el estado actual del reto
                    </p>
                    <select
                      value={data.activity_status}
                      onChange={(e) => setData('activity_status', e.target.value)}
                    ...
                    {errors.activity_status && <p className="mt-1 text-sm text-red-600">{errors.activity_status}</p>}
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mb-2">
                      Selecciona la empresa que creará este reto
                    </p>
                    <select
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                          <p className="text-blue-700 text-sm">
                            <strong>Formulario único de la categoría:</strong> Estas preguntas son específicas para la categoría "{selectedCategory.name}" y ayudarán a definir mejor los criterios del reto.
                          </p>
                        </div>
                        <div className="space-y-6">
