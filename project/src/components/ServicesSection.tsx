...
export default function ServicesSection() {
  const services = [
    {
      icon: Globe,
      title: "Sistema de Empresas Innovadoras",
      description: "Somos una empresa líder en el sector de la tecnología.",
      link: "Saber más"
    },
    {
      icon: Mail,
      title: "Conceptos de Email Marketing Efectivas",
      description: "Email marketing: Cómo enviar mensajes de impacto a través de campañas inteligentes.",
      link: "Saber más"
    },
    {
      icon: Users,
      title: "Consultoría Inteligente para Redes Sociales",
      description: "Consultoría especializada en estrategias de presencia digital y desarrollo tecnológico.",
      link: "Saber más"
    }
  ];
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <p className="text-blue-600 font-semibold mb-4">
            Descubre cómo nuestras herramientas y estrategias pueden llevar tu empresa al siguiente nivel.
          </p>
